...
public class GeneralPathCar extends Frame
{
  ...
  public void paint(Graphics g)
  {
    ...
    gp.lineTo(80,120);
    //front wheel
    gp.quadTo(90,135,100,120);
    //middle underbody
    gp.lineTo(160,120);
    //rear wheel
    gp.quadTo(170,135,180,120);
    //rear underbody
    gp.lineTo(195,118);
    //rear
    gp.curveTo(195,110, 190,85, 140,80);
    //roof
    gp.quadTo(123,81, 118,84);
    gp.moveTo(118,84);
    //windscreen
    gp.lineTo(110,94);
    //front
    gp.curveTo(95,94, 65,100, 70,120);
